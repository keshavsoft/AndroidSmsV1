...
import com.example.smsapp.ui.incoming.v10.IncomingConversationThreadScreenV10
...
fun NavGraphBuilder.incomingThreadGraph(
    ...
    composable(
        ...
        val number = backStack.arguments?.getString("number") ?: ""
        val name = backStack.arguments?.getString("name") ?: ""
        IncomingConversationThreadScreenV10(number, name) { navController.popBackStack() }
    }
